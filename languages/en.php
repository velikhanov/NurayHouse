...
"ab11" => "Architecture",
"ab12" => "The residential complex 'Nuray House MTK' consists of three sixteen-storey houses with flat roofs, built taking into account local climatic functions. The first phase of the new building was commissioned in 2018. Each building has a solid reinforced concrete frame. The new building has excellent earthquake resistance. Thermal insulation of external walls with a durable, environmentally friendly heat insulator provides a high level of energy efficiency, modern requirements.
The facade is covered with insulated paint. The complex has open unglazed balconies, as well as double-glazed windows with metal-plastic windows. The buildings are connected to the central city communications, including hot water and gas. Two lifts are installed in each building. Intercoms are installed at the entrance to the blocks. All necessary utilities, including gas, are pledged. Heating in the apartments is individual. The houses are connected to the Internet and satellite TV.",
